...
Aplicación Android (no oficial) para administrar nodos **Meshtastic** por USB OTG y Bluetooth LE, con gestión remota de repetidores **NavaTastic** mediante comandos `/nava` cifrados (PKI).
...
- A Meshtastic node with:
  - **USB OTG** (nRF52 family) or **Bluetooth LE** (pair it in system settings first; Navarrico nodes use PIN `123457`).
